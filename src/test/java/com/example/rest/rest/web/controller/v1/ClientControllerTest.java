...
public class ClientControllerTest extends AbstractTestController {
    ...
    @Test
    public void whenGetClientById_thenReternClientById() throws Exception {
    ...
    public void whenClientWithInvalidSizeName_thenReturnError(String name) throws Exception{
        var response = mockMvc.perform(post("/api/v1/client")
                .contentType(MediaType.APPLICATION_JSON)
